package fl.controls
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol2340")]
   public class Slider extends UIComponent implements IFocusManagerComponent
   {
      ...
      protected function thumbPressHandler(param1:MouseEvent) : void
      {
         ...
         _loc2_.addEventListener(MouseEvent.MOUSE_MOVE,doDrag,false,0,true);
      ...
      {
         var _loc2_:DisplayObjectContainer = focusManager.form;
         _loc2_.removeEventListener(MouseEvent.MOUSE_MOVE,doDrag);
