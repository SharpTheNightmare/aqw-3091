package liteAssets.draw
{
   ...
   public class targetAuras extends MovieClip
   {
      ...
      public function targetAuras(param1:MovieClip)
      {
         super();
      ...
      public function createIconMC(param1:String, param2:Number, param3:String = null) : void
      {
         ...
         if(!rootClass.world.myAvatar.target || Boolean(rootClass.litePreference.data.bHideUI))
         {
            return;
         }
         if(icons == null)
      ...
      public function handleAura(param1:Object) : *
      {
         ...
         for each(_loc4_ in param1.a)
         {
            if(rootClass.world.myAvatar.target)
            {
               ...
               {
                  if(_loc4_.tInf != "m:" + rootClass.world.myAvatar.target.dataLeaf.MonMapID.toString())
                  {
                     continue;
                  }
               }
               else if(_loc4_.tInf != "p:" + rootClass.world.myAvatar.target.dataLeaf.entID.toString())
               {
                  continue;
               }
            }
               ...
               for each(_loc5_ in _loc4_.auras)
               {
                  if(_loc4_.cmd.indexOf("+") > -1)
                  {
                     ...
                     else
                     {
                        ...
                        for each(_loc6_ in rootClass.world.myAvatar.target.dataLeaf.auras)
                        {
            ...
            else if(_loc4_.cmd.indexOf("+") > -1)
            {
               ...
               else
               {
                  ...
                  for each(_loc7_ in rootClass.world.myAvatar.target.dataLeaf.auras)
                  {
      ...
      public function countDownAct(param1:Event) : void
      {
         ...
         if(tp < 0.99 && Boolean(rootClass.world.myAvatar.target))
         {
            i = 0;
            while(i < 4)
            {
