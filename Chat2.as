package
{
   ...
   public class Chat2
   {
	...
	<l1 id="z" display="OK." text="OK."/>
      ...
      public function Chat2(param1:MovieClip)
      {
         super();
         r = param1;
         rootClass = param1;
      ...
      public function initObject() : void
      {
         ...
         chn.warning.col = 11010048;
         chn.server.col = 65535;
         chn.event.col = 65280;
         chn.whisper.col = 16711935;
         chn.party.col = 52479;
         chn.guild.col = 10092288;
      ...
      public function onMinimalOver(param1:MouseEvent) : void
      {
         bHovering = true;
         var _loc2_:int = 0;
         while(_loc2_ < r.ui.nc.ncTextLine.numChildren)
         {
            r.ui.nc.ncTextLine.getChildAt(_loc2_).alpha = r.ui.nc.ncTextLine.getChildAt(_loc2_).isTS ? 0.4 : 1;
            _loc2_++;
         }
      }
      
      public function onMinimalOut(param1:MouseEvent) : void
      {
         bHovering = false;
         var _loc2_:int = 0;
         while(_loc2_ < r.ui.nc.ncTextLine.numChildren)
         {
            r.ui.nc.ncTextLine.getChildAt(_loc2_).alpha = 0;
            _loc2_++;
         }
      }
      
      public function setMinimalMode(param1:Boolean) : void
      {
         var _loc2_:int = 0;
         if(param1)
         {
      ...
      private function initHistory() : MovieClip
      {
         ...
         var _loc2_:Number = 0;
         var _loc3_:int = 0;
         while(_loc3_ < cmdHistory.length)
         {
            _loc6_ = new CannedOption();
            _loc6_.y = _loc3_ * 23;
            _loc6_.addEventListener(MouseEvent.ROLL_OVER,onCmdRollOver,false,0,true);
            _loc6_.addEventListener(MouseEvent.ROLL_OUT,onCmdRollOut,false,0,true);
            _loc6_.txtChat.text = cmdHistory[_loc3_];
            if(_loc6_.txtChat.textWidth > _loc2_)
            {
               _loc2_ = Number(_loc6_.txtChat.textWidth);
            }
            _loc6_.mcMore.visible = false;
            _loc6_.strMsg = cmdHistory[_loc3_];
            _loc1_.addChild(_loc6_);
            _loc6_.addEventListener(MouseEvent.CLICK,onCmdMouseClick,false,0,true);
            _loc3_++;
         }
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.numChildren)
         {
            _loc7_ = MovieClip(_loc1_.getChildAt(_loc4_));
            _loc7_.txtChat.width = _loc2_ + 6;
            _loc7_.bg.width = _loc2_ + 20;
            _loc4_++;
         }
         var _loc5_:BevelFilter = new BevelFilter(1,45,0,1,0,1,0,0,1,3);
         _loc1_.filters = [_loc5_];
         return _loc1_;
      }
      
      private function onCmdRollOver(param1:MouseEvent) : *
      {
         var _loc2_:* = MovieClip(param1.currentTarget);
         _loc2_.bg.transform.colorTransform = new ColorTransform(1,1,1,1,25,25,25,0);
      }
      
      private function onCmdRollOut(param1:MouseEvent) : *
      {
         var _loc2_:* = MovieClip(param1.currentTarget);
         _loc2_.bg.transform.colorTransform = new ColorTransform(1,1,1,1,0,0,0,0);
      }
      
      private function onCmdMouseClick(param1:MouseEvent) : *
      {
         var _loc2_:* = MovieClip(param1.currentTarget);
         mci.ncText.text = _loc2_.strMsg;
         mcHistory.visible = false;
         r.stage.focus = null;
      }
      
      public function onHistoryClick(param1:MouseEvent) : void
      {
         if(cmdHistory.length < 1)
         {
            return;
      ...
      public function onCannedChat(param1:MouseEvent) : void
      {
      ...
      {
         if(param1.target && param1.target.parent && Boolean(param1.target.parent.id) && Boolean(param1.target.parent.hasURL))
         {
            onLinkSelected(param1.target.parent.id);
         }
      }
      
      public function onBtnShortTall(param1:MouseEvent) : void
      {
         ++iChatMode;
         if(iChatMode > 2)
         {
      ...
      public function onBtnSendText(param1:MouseEvent) : void
      {
      ...
      private function toBottom() : void
      {
         ...
         r.ui.nc.ncTextLine.y -= r.ui.nc.ncTextLine.getChildAt(r.ui.nc.ncTextLine.numChildren - 1).height - 16.25;
      }
      
      private function setScrollForBottom(param1:Boolean = false, param2:Boolean = false) : void
      {
         heightConst = bTall ? -132.95 : 83.45;
      ...
      public function onScroll(param1:MouseEvent) : void
      {
         ...
         if(!r.ui.nc.hitTestPoint(param1.stageX,param1.stageY))
         {
            return;
         }
         var _loc2_:MovieClip = r.ui.nc.ncTextLine;
         param1.delta *= 6;
         setScrollForBottom();
         _loc2_.y += param1.delta;
         if(_loc2_.y >= upConst)
         {
            _loc2_.y = upConst;
         }
         else if(_loc2_.y <= heightConst - (_loc2_.height - r.ui.nc.mask.height))
         {
            toBottom();
         }
      }
      ...
      public function pushMsg(param1:*, param2:*, param3:*, param4:*, param5:*, param6:int = 0) : *
      {
         ...
         {
            if(Boolean(r.litePreference.data.dOptions["disRed"]) && param1 == "warning")
            {
               _loc9_ = true;
         ...
         param2 = cleanStr(param2);
         var _loc7_:Boolean = false;
         if(param3 != "SERVER")
         {
            _loc10_ = 0;
            _loc11_ = rootClass.stripWhite(param2.toLowerCase());
            _loc12_ = nuProfanityCheck(param2.toLowerCase());
            _loc13_ = profanityCheck(param2.toLowerCase());
            if(param3.toLowerCase() != rootClass.sfc.myUserName && param6 == 0)
            {
               if(strContains(_loc11_,illegalStrings) || strContains(_loc11_,unsendable))
               {
                  _loc10_ = 1;
               }
               _loc11_ = r.stripWhiteStrict(param2.toLowerCase());
               if(strContains(_loc11_,["email","password"]))
               {
                  _loc10_ = 1;
               }
            ...
            if(Boolean(_loc12_.code) && Boolean(rootClass.uoPref.bProf))
            {
               param2 = maskStringBetween(param2,_loc12_.indeces);
            }
            if(!rootClass.uoPref.bProf)
            {
               _loc12_ = nuProfanityCheck(param2.toLowerCase(),true);
               if(_loc12_.code)
               {
                  param2 = maskStringBetween(param2,_loc12_.indeces);
               }
         ...
         {
            _loc14_ = messages[messages.length - 1];
            _loc15_ = 0;
            while(_loc15_ < 2)
            {
               if(_loc14_.msg == param2 && (_loc14_.user == param3 || param3 == "SERVER" && _loc14_.user == "") && _loc14_.typ == param1 && _loc14_.rnm == param4 && _loc14_.org == param5)
               {
                  return;
               }
               _loc14_ = messages[messages.length - 2];
               _loc15_++;
            }
         }
         var _loc8_:Object = {
         ...
         _loc8_.user = param3 == "SERVER" ? "" : param3;
         if(isChannel(param1))
         {
            if(param1 == "zone")
            {
               param3 = r.strToProperCase(param3);
               popBubble("u:" + param3,param2,param1);
            }
            messages.push(_loc8_);
            _loc16_ = heightConst - (r.ui.nc.ncTextLine.height - r.ui.nc.mask.height);
            wasBottom = Math.round(r.ui.nc.ncTextLine.y) == Math.round(_loc16_);
            buildMessage(messages[messages.length - 1]);
         }
         if(_loc7_)
         {
            pushMsg("warning",param3 + " IS NOT A MODERATOR.  DO NOT GIVE ACCOUNT INFORMATION TO OTHER PLAYERS.","SERVER","",0);
            _loc17_ = "<font color=\'#FF0000\'>WARNING</font><br/><font color=\'#FFFFFF\'>" + param3.toUpperCase() + "</font><font color=\'#FFFFFF\'> IS NOT A MODERATOR.<br/>Do not give account information to other players.<font>";
            _loc17_ = _loc17_ + "<br/><a href=\'event:link::https://aq.com/safety.asp\'><font color=\'#66CCFF\'><u>Click here</u></font></a> to learn more.";
      ...
      {
         if(Boolean(mci) && Boolean(r.ui.nc))
         {
      ...
      public function bMinMaxClick(param1:MouseEvent) : void
      {
      }
      ...
      public function buildMessage(param1:Object) : void
      {
         ...
         var _loc2_:DropShadowFilter = new DropShadowFilter(0,45,0,1,3,3,5,1,false,false,false);
         if(format_time() != "")
         {
            _loc12_ = new TextField();
            _loc13_ = new TextFormat();
            _loc13_.font = "Arial";
            _loc13_.size = 9;
            _loc13_.color = 16777215;
            _loc13_.indent = -10;
            _loc13_.leftMargin = 10;
            _loc13_.align = TextFormatAlign.RIGHT;
            _loc14_ = format_time();
            _loc12_.text = _loc14_;
            _loc12_.antiAliasType = AntiAliasType.ADVANCED;
            _loc12_.embedFonts = true;
            _loc12_.setTextFormat(_loc13_,0,_loc12_.text.length);
            _loc12_.filters = [_loc2_];
            _loc12_.width = 44.1;
         ...
         _loc5_.font = "Arial";
         _loc5_.size = 11;
         _loc5_.color = chn[param1.typ].col;
         _loc5_.indent = -10;
         _loc5_.leftMargin = 10;
         if(param1.typ == "whisper")
         {
            if(param1.user == r.sfc.myUserName || isMyModHandle(param1.user))
            {
               if(param1.org == 0)
               {
                  _loc5_.color = uint("0x" + rootClass.modColor("FF00FF","666666","-"));
                  _loc6_ = "To ";
               }
               else
               {
         ...
         {
            _loc6_ = chn[param1.typ].tag == "" ? "" : "[" + chn[param1.typ].tag + "] ";
         }
         if(param1.typ == "whisper")
         {
            if(param1.user == r.sfc.myUserName || isMyModHandle(param1.user))
         ...
         {
            _loc7_ = param1.user + (param1.user == "" ? "" : ": ");
         }
         _loc3_.text = _loc6_ + _loc7_ + param1.msg;
         ...
         if(_loc6_ != "")
         {
            _loc3_.setTextFormat(_loc5_,0,_loc6_.length);
            _loc3_.setTextFormat(_loc4_,_loc6_.length,_loc6_.length + _loc7_.length);
            _loc3_.setTextFormat(_loc5_,_loc6_.length + _loc7_.length,_loc3_.text.length);
         }
         else if(_loc7_ != "")
         {
            _loc3_.setTextFormat(_loc4_,0,_loc7_.length - 2);
            _loc3_.setTextFormat(_loc5_,_loc7_.length - 2,_loc3_.text.length);
         }
         else
         {
            _loc3_.setTextFormat(_loc5_,0,_loc3_.text.length);
         }
         _loc3_.width = param1.tMC ? 266.5 : 314;
         var _loc8_:TextFormat = new TextFormat();
         _loc8_.font = "Arial";
         _loc8_.size = 11;
         _loc8_.color = 16777113;
         _loc8_.underline = true;
         var _loc9_:Object = regExpURL.exec(_loc3_.text);
         while(_loc9_ != null)
         {
            _loc3_.setTextFormat(_loc8_,_loc9_.index,_loc9_.index + _loc9_[0].length);
            _loc9_ = regExpURL.exec(_loc3_.text);
            param1.hasURL = true;
         }
         ...
         if(param1.tMC)
         {
            _loc17_ = r.ui.nc.ncTextLine.addChild(param1.tMC);
            _loc17_.mouseEnabled = false;
            _loc17_.id = param1.id;
            _loc17_.isTS = true;
            if(messages.length > 1)
            {
               _loc17_.y = messages[messages.length - 2].mc.y + messages[messages.length - 2].mc.height + 1.55;
            }
            if(bMinimal && !bHovering)
            {
               fadeQueue.push([_loc17_,new Date().getTime()]);
            }
         }
         var _loc11_:MovieClip = r.ui.nc.ncTextLine.addChild(param1.mc);
         _loc11_.mouseEnabled = false;
         _loc11_.id = param1.id;
         _loc11_.hasURL = param1.hasURL;
         _loc11_.x = param1.tMC ? 47.45 : 0;
         if(messages.length > 1)
         {
            _loc11_.y = messages[messages.length - 2].mc.y + messages[messages.length - 2].mc.height;
         }
         if(bMinimal && !bHovering)
         {
            fadeQueue.push([_loc11_,new Date().getTime()]);
         }
         setScrollForBottom(true,param1.typ == "server" && param1.msg == "Character load complete.");
      }
      
      public function onLinkSelected(param1:Number) : void
      {
         ...
         {
            if(_loc2_.id == param1 && Boolean(_loc2_.hasURL))
            {
               _loc3_ = regExpURL.exec(_loc2_.msg);
               while(_loc3_ != null)
               {
                  _loc4_ = new ModalMC();
                  _loc5_ = {};
                  _loc5_.strBody = "Are you sure you want to go to " + _loc3_[0] + "?";
                  _loc5_.callback = urlTraverse;
                  _loc5_.params = {"url":_loc3_[0]};
                  _loc5_.btns = "dual";
                  r.ui.ModalStack.addChild(_loc4_);
                  _loc4_.init(_loc5_);
                  _loc3_ = regExpURL.exec(_loc2_.msg);
               }
            }
      ...
      public function urlTraverse(param1:Object) : void
      {
         if(param1.accept)
         {
      ...
      public function fadeEffect(param1:TimerEvent) : void
      {
         var _loc2_:* = undefined;
         var _loc3_:int = 0;
         ...
         if(bHovering || fadeQueue.length < 1)
         {
            ...
            {
               _loc3_ = 0;
               while(_loc3_ < r.ui.nc.ncTextLine.numChildren)
               {
                  r.ui.nc.ncTextLine.getChildAt(_loc3_).alpha = 0;
                  _loc3_++;
               }
            }
            return;
         }
         for each(_loc2_ in fadeQueue)
         {
            if(!_loc2_[0])
            {
               if(fadeQueue.indexOf(_loc2_[0]) != -1)
               {
                  fadeQueue.splice(fadeQueue.indexOf(_loc2_[0]),1);
               }
            }
            else if((new Date().getTime() - _loc2_[1]) / 1000 >= 45)
            {
               if(_loc2_[0].alpha > 0)
               {
                  _loc2_[0].alpha -= 0.05;
      ...
      public function rebuild() : void
      {
         ...
         clearMessages();
         var _loc2_:* = 0;
         for(; _loc2_ < messages.length; _loc2_++)
         {
            _loc3_ = messages[_loc2_];
            if(filterCode > 0)
            {
               if(filterCode == 1)
               {
               ...
               {
                  if(_loc3_.typ != "zone" && _loc3_.typ != "moderator" && _loc3_.typ != "whisper")
                  {
                     continue;
                  }
               }
            ...
            if(_loc3_.tMC)
            {
               _loc5_ = r.ui.nc.ncTextLine.addChild(_loc3_.tMC);
               _loc5_.mouseEnabled = false;
               _loc5_.id = _loc3_.id;
               _loc5_.x = 0;
               if(_loc1_)
               {
                  _loc5_.y = _loc1_.mc.y + _loc1_.mc.height + 1.55;
               }
               else
               {
                  _loc5_.y = 1.55;
            ...
            _loc4_ = r.ui.nc.ncTextLine.addChild(_loc3_.mc);
            _loc4_.mouseEnabled = false;
            _loc4_.id = _loc3_.id;
            _loc4_.hasURL = _loc3_.hasURL;
            _loc4_.x = _loc3_.tMC ? 47.45 : 0;
            if(_loc1_)
            {
               _loc4_.y = _loc1_.mc.y + _loc1_.mc.height;
            }
            else
            {
               _loc4_.y = 0;
      ...
      {
         if(param1.split("-")[0] == "Moderator" && Boolean(int(param1.split("-")[1] == r.world.modID)))
         {
            return true;
         }
         return false;
      ...
      public function profanityCheck(param1:String) : Object
      {
         ...
         _loc2_ = " " + cleanStr(param1.toLowerCase()) + " ";
         _loc2_ = r.stripMarks(_loc2_);
         _loc2_ = r.stripDuplicateVowels(_loc2_);
         _loc3_ = 0;
         while(_loc3_ < profanityA.length)
         {
         ...
         _loc2_ = r.stripDuplicateVowels(cleanStr(param1.toLowerCase()));
         _loc2_ = r.stripWhiteStrict(_loc2_);
         _loc3_ = 0;
         ...
         _loc2_ = r.stripDuplicateVowels(cleanStr(param1.toLowerCase()));
         _loc2_ = r.stripWhiteStrictB(_loc2_);
         _loc3_ = 0;
         while(_loc3_ < profanityB.length)
         {
            _loc4_.index = _loc2_.indexOf(profanityB[_loc3_]);
               ...
               switch(paramStr)
               {
                  ...
                  case "gr":
                     ...
                     if(typeof params[1] != "undefined" && params[1].length > 0)
                     {
                        ...
                        if(r.world.myAvatar.objData.guildRank >= 2 || Boolean(avt.isMyAvatar))
                        {
                           modal = new ModalMC();
                           modalO = {};
                  ...
                  case "modban":
                     ...
                     break;
                  case "join":
                     if(typeof params[1] != "undefined" && params[1].length > 0 && r.world.uoTree[r.sfc.myUserName].intState != 0 && Boolean(r.world.coolDown("tfer")))
                     {
                  ...
                  case "goto":
                     ...
                     {
                        cmd = null;
                        r.world.goto(params.slice(1).join(" "));
                     }
                     break;
                  case "pull":
                     if(typeof params[1] != "undefined" && params[1].length > 0)
                  ...
                  case "roll":
                     ...
                     break;
                  case "geta":
                     if(Boolean(r.world.myAvatar.isStaff()) && params.length == 3)
                     {
                        pushMsg("warning","geta " + params[1] + "," + params[2] + ": " + r.world.getAchievement(params[1],params[2]),"SERVER","",0);
                     }
                     break;
                  case "seta":
                     if(Boolean(r.world.myAvatar.isStaff()) && params.length == 4)
                     {
                  ...
                  case "facepalm":
                     ...
                     break;
                  default:
                     if(unm == "iterator" || Boolean(r.world.myAvatar.isStaff()))
                     {
                        cmd = "cmd";
                        index = 0;
            ...
            else if(cmd != "simple")
            {
               if(!(cmd == null || xtArr.length < 1))
               {
                  if(!r.serialCmdMode)
                  {
                     ...
                     else if(iChat == 1 && !r.world.myAvatar.hasUpgraded() && !r.world.myAvatar.isVerified() && !r.world.myAvatar.isStaff())
                     {
                        pushMsg("warning","Chat is a members-only feature at this time.","SERVER","",0);
                     }
                     else if(!r.world.myAvatar.hasUpgraded() && !r.world.myAvatar.isVerified() && !r.world.myAvatar.isStaff() && !r.world.myAvatar.isEmailVerified())
                     {
                     ...
                     else if(myAvatar.objData.dMutedTill != null && myAvatar.objData.dMutedTill.getTime() > r.date_server.getTime())
                     {
               ...
               switch(_loc4_.substr(1))
               {
                  ...
                  case "say":
                     if(chn.zone.act)
                     {
                        ...
                        mci.ncText.text = mci.ncText.text.substr(_loc4_.substr(1).length + 2);
                     }
                     formatMsgEntry("");
                     updateMsgEntry();
                     break;
                  ...
                  case "w":
                     if(_loc3_.length > 2)
                     {
                        pmMode = 1;
                        chn.cur = chn.whisper;
                        mci.ncText.text = mci.ncText.text.substr(_loc3_[0].length + _loc3_[1].length + 1);
