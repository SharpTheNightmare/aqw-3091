package org.sepy.ColorPicker
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol2681")]
   public class AdvColorPanel extends MovieClip
   {
      ...
      public function AdvColorPanel(param1:Object)
      {
         super();
      ...
      public function changed(param1:MovieClip, param2:Number) : void
      {
         _hlsrgb.color = new RGB(_red_mc.value,_green_mc.value,_blue_mc.value);
         var _loc3_:Number = _hlsrgb.getRGB();
         color_map.findTheColor(_loc3_);
         this.change(this,_loc3_);
      }
      
      private function RGBtoColor(param1:Object) : int
      {
         var _loc2_:int = 0;
         _loc2_ += param1.red << 16;
         _loc2_ += param1.green << 8;
         return int(_loc2_ + param1.blue);
      }
      
      public function change(param1:MovieClip, param2:Number) : void
      {
         var _loc3_:Object = ColorToRGB(param2);
         if(param1 == color_map)
         {
            color = _loc3_;
            color_slider.color = param2;
            color_display.transform.colorTransform = new ColorTransform(1,1,1,1,_loc3_.red,_loc3_.green,_loc3_.blue,0);
            updateHLS(color_slider.getCurrentColor(),true);
         }
         else if(param1 == this)
         {
      ...
      public function changing(param1:Number) : void
      {
         var _loc2_:Object = ColorToRGB(param1);
         color_display.transform.colorTransform = new ColorTransform(1,1,1,1,_loc2_.red,_loc2_.green,_loc2_.blue,0);
         color = _loc2_;
         updateHLS(color_slider.getCurrentColor(),true);
      }
      
      private function updateHLS(param1:Number, param2:Boolean) : *
      {
         var _loc3_:Object = null;
         if(param2)
         {
            _loc3_ = ColorPicker2.ColorToRGB(param1);
            _hlsrgb.hue = _hlsrgb.saturation = _hlsrgb.luminance = 0;
            _hlsrgb.red = _loc3_.red;
            _hlsrgb.green = _loc3_.green;
            _hlsrgb.blue = _loc3_.blue;
         }
      ...
      public function set color(param1:Object) : *
      {
         _color = param1;
      }
      ...
      public function set hue(param1:Number) : *
      {
         param1 = Math.round(param1);
         _hue = param1;
         _hue_mc.value = param1;
      }
      
      public function set saturation(param1:Number) : *
      {
         param1 = Math.round(param1 * 240);
         _saturation = param1;
         _saturation_mc.value = param1;
      }
      
      public function set luminosity(param1:Number) : *
      {
         param1 = Math.round(param1 * 240);
         _luminosity = param1;
         _luminosity_mc.value = param1;
      }
      
      public function set red(param1:Number) : *
      {
         _red = param1;
         _red_mc.value = param1;
      }
      
      public function set green(param1:Number) : *
      {
         _green = param1;
         _green_mc.value = param1;
      }
      
      public function set blue(param1:Number) : *
      {
         _blue = param1;
         _blue_mc.value = param1;
      }
